...
export default async function TodayDealsPage({ params }: PageProps) {
    const { locale: rawLocale, country } = await params;
    const locale: Locale = isValidLocale(rawLocale) ? rawLocale : DEFAULT_LOCALE;
            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    <div className="lg:col-span-8 xl:col-span-9">
                        ...
                        <p className="text-sm text-gray-500 mb-4 font-medium">{coupons.length} {isEn ? "deals available" : "عرض متاح"}</p>
                        ...
                        {coupons.length > 0 ? (
                            ...
                            <div className="bg-white p-20 rounded-3xl text-center border-2 border-dashed border-gray-200">
                                ...
                                <h2 className="text-xl font-bold text-gray-800 mb-2">{isEn ? "No deals today" : "لا توجد عروض اليوم"}</h2>
                        ...
                        <section className="mt-12 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-6">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                                ...
                                <Link href={`/${locale}/${country}/new-coupons`} className="bg-white rounded-xl p-4 text-center hover:shadow-md transition-shadow font-bold text-sm text-gray-700 hover:text-blue-600">✨ {isEn ? "New Coupons" : "كوبونات جديدة"}</Link>
